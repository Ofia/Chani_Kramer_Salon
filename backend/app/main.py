...
from app.routes import employees, customers, expenses, payroll, financials, users, ella, wig_orders, board_posts, notifications, checkins, inventory, pos_sales, time_logs, providers, repair_services, wash_set_services, reports, appointments, cart, invoice_import, repair_orders, repair_tasks
...
app.include_router(wash_set_services.router, prefix="/api/v1")
app.include_router(reports.router,         prefix="/api/v1")
app.include_router(appointments.router,    prefix="/api/v1")
app.include_router(cart.router,            prefix="/api/v1")
app.include_router(invoice_import.router,  prefix="/api/v1")
app.include_router(repair_orders.router,   prefix="/api/v1")
app.include_router(repair_tasks.router,    prefix="/api/v1")
