...
// Same tab definitions as OwnerLayout — roles control visibility as permissions stack
...
export default function BookkeeperLayout() {
  ...
  // Real bookkeepers always see all their tabs; owners see filtered tabs based on viewingAs
