                ...
                {({ isActive }) => (
                  <>
                    <Icon size={15} strokeWidth={1.8}
                      color={isActive ? '#212121' : 'rgba(13,13,13,0.35)'} />
...
const s: Record<string, React.CSSProperties> = {
  ...
  searchBtn: {
    ...
    color: 'rgba(13,13,13,0.35)', fontSize: 12, cursor: 'pointer',
    textAlign: 'left' as const,
  },
  searchLabel: { flex: 1 },
  kbd: {
    fontSize: 10, background: '#f0f0ee',
    border: '1px solid rgba(13,13,13,0.09)', borderRadius: 4,
    padding: '1px 5px', color: 'rgba(13,13,13,0.35)',
  },
  ...
  switchBtn: {
    ...
    background: '#ffffff', border: '1px solid rgba(13,13,13,0.09)',
    color: '#0d0d0d', borderRadius: 8, padding: '7px 10px',
