...
// Each tab declares which roles can see it. Ordered so items "stack" from bottom as permissions grow.
    ...
    <div style={s.shell}>
      <aside style={s.sidebar}>
        <div style={s.top}>
          ...
          <nav style={s.nav}>
            {/* Owner-only section — hidden when previewing other roles */}
            {viewingAs === 'owner' && (
            ...
            {/* Bookkeeping section — filtered by viewingAs */}
